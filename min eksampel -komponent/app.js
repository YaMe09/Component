    ...
    <div>
      <div v-if="userClass === 'Database'">
          ...
          <div style="color:  rgb(2, 2, 57);">
            ...
            <img class="billder" src="./images/Nilma.jpg" alt="Nilma Abbas (Database)" />
            <br />
            Nilma Abbas
          </div>
      </div>
      ...
      <div v-else-if="userClass === 'FB'">
        ...
        <div style="color:  purple;">
          ...
          <img class="billder" src="./images/Steen.png" alt="Steen Jensen (Frontend)" />
          <br />
          Steen Jensen
        </div>
      </div>
      ...
      <div v-else-if="userClass === 'UX'">
        ...
        <div style="color: rgb(77, 128, 0);">
          ...
          <img class="billder" src="./images/Miceal.jpg" alt="Michael Hammel (UX)" />
          <br />
          Michael Hammel
        </div>
      </div>
